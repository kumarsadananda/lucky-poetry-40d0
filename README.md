...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/lucky-poetry-40d0#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-poetry-40d0
```

A live public deployment of this template is available at [https://lucky-poetry-40d0.templates.workers.dev](https://lucky-poetry-40d0.templates.workers.dev)
